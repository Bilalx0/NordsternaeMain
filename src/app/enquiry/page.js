...
export default function Home({ params }) {
  ...
  const propRef = params.reference || ''; // Fallback to empty string if no reference
    ...
    <Flex direction="column" w={{ base: '100vw', md: '80vw', lg: '946px' }} mx="auto" color="#000000" justify="center" align="center">
      <Flex direction={{ base: 'column', md: 'row' }} justify="center" py={8}>
        <Flex direction="column" px={4} w={{ base: '100%', md: '570px' }}>
          ...
          <Text my={2}>
            If you require immediate assistance, please don&apos;t hesitate to reach us on{' '}
            <Link href="tel:+971042889093">
              <u>+971 (0) 4 288 9093</u>
            </Link>
          </Text>
          ...
          {!messageSent && (
            <Flex my={8} direction="column">
              ...
              <Input
                ...
                variant="outline"
                type="tel"
                placeholder="PHONE NUMBER (+971 X XXX XXXX)"
                _placeholder={{ fontSize: '10px' }}
              ...
              <Button onClick={handleAddItem} my={4} variant="bigCTA">
                SUBMIT ENQUIRY
              </Button>
            </Flex>
          )}
          {!!messageSent && (
            <Flex direction="column" align="center" p={8}>
              <Text as="b" color="#43f143" variant="robotoNormalTitle">
          ...
          <Flex direction="column" alignSelf="flex-start">
            <Text variant="latoBoldText" align="left">
              Need Immediate Assistance?
            </Text>
            <Flex my={2}>
              <Button my={2} as="a" href="mailto:leads@nordstern.ae" size="s" w="150px" variant="light" mr={4}>
                EMAIL
              </Button>
              <Button my={2} as="a" href="https://wa.me/971564264660" size="s" w="150px" variant="light">
                WHATSAPP
              </Button>
            </Flex>
        ...
        <Flex direction="column" alignSelf="flex-start" justify="center" align="left" p={4} mt={14}>
          ...
          <Link mt={4} href="https://maps.app.goo.gl/YXHzvFpKi9idzKBQ9" isExternal>
            <Text as="u">View on Google Maps</Text>
          </Link>
        </Flex>
      </Flex>
      <Flex direction="column" bg="#FDF9F3" w="100vw">
        <Text variant="robotoNormalTitle" alignSelf="center" my={4}>
        ...
        <Flex direction={{ base: 'column', md: 'row' }} w={{ base: '100vw', md: '80vw', lg: '946px' }} mx="auto" p={4} justify="space-between">
          <Flex direction="column">
            ...
            <Flex direction="column" p={4} justify="center" align="center" maxW="440px">
              ...
              <Text fontSize="16px" align="center" my={4}>
                Our team offers a diversity of experience and expertise.
              </Text>
              <Link href="/aboutnordstern">
                <Text variant="selected" fontSize="12px" fontWeight="bold">
                  MEET THE SALES TEAM
                </Text>
              </Link>
            </Flex>
